...
if (!(Test-Path -Path "./logs/FITS_fix/wind1_abl")) {
    New-Item -ItemType Directory -Path "./logs/FITS_fix/wind1_abl"
}
# seq_len=700
$model_name = "FITS"
$H_order = 6
...
& python -u run_longExp_F.py `
  ...
  --num_workers 0 `
  --patience 3 `
  --itr 1 --batch_size $bs --learning_rate 0.0005 > logs/FITS_fix/wind1_abl/$m'_'$model_name'_feature'$features'_'Etth1_$seq_len'_'$pred_len'_H'$H_order'_bs'$bs'_s'$seed.log
