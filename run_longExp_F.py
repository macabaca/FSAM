...
# SparseTSF
parser.add_argument('--period_len', type=int, default=16, help='period length')
...
# EDL FITS
parser.add_argument('--lambda1', type=float,default=1.0, help='balance EDL and Linear')
parser.add_argument('--lambda2', type=float,default=1.0, help='inside EDLloss')
parser.add_argument('--lambda3', type=float,default=1.0, help='balance EDL of low and EDL of high freq')

# FITS FA
parser.add_argument('--use_bug', action='store_true', default=False, help='refix bug in TFB')

# FLinear-patch
parser.add_argument('--if_complex', type=int, default=1, help='use complex 1 seperate 0')
parser.add_argument('--main_freq', type=int, default=24)
parser.add_argument('--patch_len', type=int, default=24)
parser.add_argument('--patch_in', type=int, default=24)
parser.add_argument('--patch_out', type=int, default=24)
parser.add_argument('--cutoff_ratio', type=float, default=1.0)
parser.add_argument('--stride', type=int, default=1)
parser.add_argument('--if_pad', type=int, default=0)
parser.add_argument('--upsample_complex', type=int, default=1)
parser.add_argument('--lambda_cid', type=float, default=1.0)
# FLinear-patch
parser.add_argument('--mask_file', type=str, default='')
parser.add_argument('--mask_id', type=int, default=1, help='1:Mahalanobis; 2:Granger_Causality; 3:prob')
parser.add_argument('--threshold', type=float, default=0.5)
parser.add_argument('--crit_method', type=int, default=1, help='0:mse; 1:mae')
...
if args.cut_freq == 0:
    args.cut_freq = int(args.seq_len // args.base_T ) * args.H_order + 1
